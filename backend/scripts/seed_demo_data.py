...
PROJECTS = [
    ...
    {
        "title": "Botanical Courtyard Mural",
        "slug": "botanical-courtyard-mural",
        "category": "murals",
        "description": "Hand-painted botanical mural for a restaurant courtyard.",
        "featured": False,
        "status": Project.Status.PUBLISHED,
        "client_name": "Verde Restaurant",
        "n_images": 3,
        "n_videos": 0,
    },
    {
        "title": "Subway Underpass",
        "slug": "subway-underpass",
        "category": "murals",
        "description": "Community mural project transforming a pedestrian underpass.",
        "featured": False,
        "status": Project.Status.PUBLISHED,
        "client_name": "City Council",
        "n_images": 2,
    ...
    },
    {
        ...
        "category": "fine-art",
        "description": "A series of oil still-life studies exploring color and light.",
        "featured": False,
        "status": Project.Status.PUBLISHED,
        "client_name": "",
        "n_images": 3,
    ...
    },
    {
        ...
        "slug": "citrus-study",
        "category": "fine-art",
        "description": "Fine art painting study of citrus fruit and ceramics.",
        "featured": False,
        "status": Project.Status.PUBLISHED,
        "client_name": "",
        "n_images": 2,
    ...
    {
        "title": "Good Days Coffee Packaging",
        "slug": "good-days-coffee-packaging",
        "category": "graphic-design",
        "description": "Packaging and label design for a specialty coffee brand.",
        "featured": False,
        "status": Project.Status.PUBLISHED,
        "client_name": "Good Days Coffee",
        "n_images": 3,
        "n_videos": 0,
    },
    {
        "title": "Sol Skincare Branding",
        "slug": "sol-skincare-branding",
        "category": "brand-design",
        "description": "Brand identity and packaging system for a skincare line.",
        "featured": False,
        "status": Project.Status.PUBLISHED,
        "client_name": "Sol Skincare",
        "n_images": 3,
        "n_videos": 0,
    },
    {
        "title": "Studio Stationery Set",
        "slug": "studio-stationery-set",
        "category": "brand-design",
        "description": "Business card, letterhead, and stationery suite for a design studio.",
        "featured": False,
        "status": Project.Status.PUBLISHED,
        "client_name": "",
        "n_images": 2,
